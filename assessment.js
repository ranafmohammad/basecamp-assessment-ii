...
// #3 Below is an object, 'message'. Below it, add a 'text' key using bracket notation and assign it a string of
...
// CODE HERE
var myFriends = ["umer", "wahab", "saif", "haseeb"];

// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE

myFriends.push("Arsalan");
...
function evensOnly() {
  // CODE HERE
 return  myNumbers.filter(function(evenOnly){
  return evenOnly % 2 === 0
});
}
